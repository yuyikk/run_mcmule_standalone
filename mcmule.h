...
#include <string.h>
    ...
    extern void __nucl_protonff_MOD_proton_dipole(real *q2, real *Ge, real *Gm);
    extern void __nucl_protonff_MOD_proton_monopole(real *q2, real *Ge, real *Gm);
...
#define mcmule_nr_q __user_dummy_MOD_nr_q
    extern size_t mcmule_namelen;

#define MCMULE_SET_NAME(q, name) strncpy(mcmule_names + q * mcmule_namelen, name, mcmule_namelen);
